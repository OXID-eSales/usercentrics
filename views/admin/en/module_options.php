...
$aLang = [
    "charset"                                    => "UTF-8",
    'SHOP_MODULE_GROUP_usercentrics_main'        => 'Settings',
    ...
    'HELP_SHOP_MODULE_usercentricsMode'          => 'Choose the mode for Usercentrics. A documentation about versions, legacy browser support and TCF support can be found at <a target="_blank" href="https://docs.usercentrics.com/">docs.usercentrics.com</a>. Choose "Include usercentrics script by yourself" if the module itself should not add the usercentrics script.',
];
