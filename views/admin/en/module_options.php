...
$aLang = [
    ...
    'HELP_SHOP_MODULE_usercentricsMode'           => 'Choose the mode for Usercentrics. A documentation about versions, 
legacy browser support and TCF support 
can be found at <a href="https://docs.usercentrics.com/">docs.usercentrics.com</a>.
Choose "Include usercentrics script by yourself" if the module itself should not add the usercentrics script.
 ',
];
